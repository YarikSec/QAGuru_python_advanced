...
"""
Тесты на доступность веб-сервиса
1. Проверить доступность веб-сервиса url
2. Проверить, что при обращении к url сервис возвращает статус 200
3. Проверить порт сервиса
"""
